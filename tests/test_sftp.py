...
class TestSFTPStorage:
    ...
    def test_sftp_get_file(self, sftp, m_sftp, m_log):
        ...
        m_sftp.get.assert_called_once_with('some-file.txt', '/fake/some-file-dest.txt', DontCare())
    ...
    def test_sftp_put_file(self, sftp, m_sftp, m_log):
        ...
        m_sftp.put.assert_called_once_with('/tmp/abc/baz.txt', 'dest/zab.txt', DontCare())
        m_log.info.assert_called_once_with(
